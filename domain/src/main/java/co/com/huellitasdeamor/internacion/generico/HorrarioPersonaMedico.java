...
public class HorrarioPersonaMedico implements ValueObject<String> {

    private final String value;

    public HorrarioPersonaMedico(String value){
    ...
    public boolean equals(Object prueba) {
        ...
        HorrarioPersonaMedico that = (HorrarioPersonaMedico) prueba;
