...
public class FinalizarTurnoPersonalMedico extends Command {
    private final CuartoHospitalizacionID cuartoHospitalizacionID;
    private final PersonalMedicoID personalMedicoID;

    public FinalizarTurnoPersonalMedico(CuartoHospitalizacionID cuartoHospitalizacionID, PersonalMedicoID personalMedicoID) {
